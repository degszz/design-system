        ...
        <>
            <div class='flex z-10 w-full justify-between fixed h-12 backdrop-blur-md border-b-2 border-black-900'>
                <div className="flex justify-around w-fit md:w-1/2 lg:w-1/3 items-center">
                                    ...
                                    <ul className="">
                                        <div className="flex flex-col justify-start">
                                            ...
                                            {links.map(({ label, route }) =>
                                                <Link className='p-2 hover:underline cursor-pointer' href={route}>
                                                    {label}
                                                </Link>
                                            )}
                                        </div>
                    ...
                    {links3.map(({ label, route }) =>
                        <div className="flex w-fit items-center">
                            <Link className='hidden md:block focus:underline dark:focus:text-white p-1 w-fit cursor-pointer text-black-950 hover:underline hover:text-black-950 dark:text-black-50 dark:hover:text-white' href={route}>
                                <b>{label}</b>
                            </Link>
                        </div>
                    )}
